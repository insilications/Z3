...
Version  : 4.8.8
Release  : 22
URL      : https://github.com/Z3Prover/z3/archive/z3-4.8.8/z3-4.8.8.tar.gz
Source0  : https://github.com/Z3Prover/z3/archive/z3-4.8.8/z3-4.8.8.tar.gz
...
%prep
%setup -q -n z3-z3-4.8.8
cd %{_builddir}/z3-z3-4.8.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589227627
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/z3-z3-4.8.8/LICENSE.txt %{buildroot}/usr/share/package-licenses/Z3/dad4e766bd1dda39916ad6d99a48f02c6884438a
pushd clr-build32
%make_install32
...
/usr/lib64/libz3.so.4.8.8.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libz3.so.4.8
/usr/lib32/libz3.so.4.8.8.0
