...
Source0  : https://github.com/Z3Prover/z3/archive/z3-4.8.1.tar.gz
...
%prep
%setup -q -n z3-z3-4.8.1
pushd ..
cp -a z3-z3-4.8.1 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1539664277
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/haswell/libz3.so.4.8.1.0
/usr/lib64/libz3.so.4.8
/usr/lib64/libz3.so.4.8.1.0
